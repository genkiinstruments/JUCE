...
if (EMSCRIPTEN_FORCE_PTHREADS)
	add_link_options(-pthread -sUSE_PTHREADS=1 -sPTHREAD_POOL_SIZE=4 -sDISABLE_EXCEPTION_CATCHING=0)
	add_compile_options(-pthread -sUSE_PTHREADS=1 -sPTHREAD_POOL_SIZE=4 -sDISABLE_EXCEPTION_CATCHING=0)
endif ()

set(USE_FLAGS "-s USE_SDL=2 -s USE_FREETYPE=1 -pthread -s USE_PTHREADS=1 -g")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${USE_FLAGS}")
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${USE_FLAGS}")
set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} ${USE_FLAGS}")

set(CMAKE_C_FLAGS_DEBUG "-DNDEBUG -O0 -pthread -s USE_PTHREADS=1" CACHE STRING "Emscripten-overridden CMAKE_C_FLAGS_DEBUG")
...
set(CMAKE_CXX_FLAGS_DEBUG "-DNDEBUG -O0 -pthread -s USE_PTHREADS=1" CACHE STRING "Emscripten-overridden CMAKE_CXX_FLAGS_DEBUG")
...
set(CMAKE_EXE_LINKER_FLAGS_DEBUG "-O0 -pthread -s USE_PTHREADS=1" CACHE STRING "Emscripten-overridden CMAKE_EXE_LINKER_FLAGS_DEBUG")
...
set(CMAKE_SHARED_LINKER_FLAGS_DEBUG "-O0 -pthread -s USE_PTHREADS=1" CACHE STRING "Emscripten-overridden CMAKE_SHARED_LINKER_FLAGS_DEBUG")
...
set(CMAKE_MODULE_LINKER_FLAGS_DEBUG "-O0 -pthread -s USE_PTHREADS=1" CACHE STRING "Emscripten-overridden CMAKE_MODULE_LINKER_FLAGS_DEBUG")
